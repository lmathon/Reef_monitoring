setwd("C:/Users/mathonlocal/Desktop/Nature Foundation/CORENA Project/Reef_Monitoring/R_scripts/02_Analyses_Plots/BRT/BRT_Fish_abundance")
...
partial_dependance_plots3 <- function(model, responseName_brts, distrib){
  ...
  for (j in 1:length(predictors)){
    ...
    plot(a, ylab="Fish abundance", pch = 16, cex.axis=1.2, cex.lab=1.5, cex = 1)
