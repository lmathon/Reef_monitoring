...
myResponse=c("Herbivorous_Abundance")

myPredictor=c("Year", "Protection","cyclone", "SST", "Piscivorous_Abundance",
...
myPredictorNumeric=c("SST", "DHW", "dist_to_coast", "CORAL", "GORGONIANS", "SPONGES", "MACROALGAE", "Piscivorous_Abundance",
                     "DEAD CORAL WITH ALGAE", "Number_frames_bleaching", "Number_frames_disease", "Recruits_density")
...
var_sup5_best_fixed <- gsub("`","", var_sup5_best_fixed)
